...
e(this).hasClass("black-chart"))switch(s){case"circle":t={chartArea:{left:0,top:0,width:"100%",height:"75%"},colors:["#304ffe","#f60e0e","#ffa000"],fontName:"Poppins",backgroundColor:c,legend:{position:"bottom",textStyle:{color:"#484848"}},vAxis:{baselineColor:"#484848",gridlines:{color:"#484848"},textStyle:{color:"#484848"}},hAxis:{textStyle:{color:"#484848"}}},r=new google.visualization.PieChart(document.getElementById(l));break;





case"donut":t={pieHole:.3,chartArea:{left:0,top:0,width:"100%",height:"100%"},
legend:{position:"bottom",textStyle:{color:"#484848"}},
colors:["#304ffe","#f60e0e","#ffa000", "00f700", "a5236e"],
fontName:"Poppins",backgroundColor:c},r=new google.visualization.PieChart(document.getElementById(l));
break;


case"column":t={chartArea:{left:30,top:10,width:"100%",height:"90%"},
colors:["#304ffe","#f60e0e","#ffa000"],fontName:"Poppins",
backgroundColor:c,vAxis:{baselineColor:"#484848",gridlines:{color:"#484848"},
textStyle:{color:"#484848"}},hAxis:{textStyle:{color:"#484848"}}},
r=new google.visualization.ColumnChart(document.getElementById(l));
break;


case"curve":t={chartArea:{left:30,top:10,width:"90%",height:"80%"},
curveType:"function",colors:["#304ffe","#f60e0e","#ffa000"],fontName:"Poppins",
backgroundColor:c,vAxis:{baselineColor:"#484848",gridlines:{color:"#484848"},
textStyle:{color:"#484848"}},hAxis:{textStyle:{color:"#484848"}}},
r=new google.visualization.LineChart(document.getElementById(l));break;


case"line":t={chartArea:{left:30,top:10,width:"100%",height:"80%"},
fontName:"Poppins",backgroundColor:c,vAxis:{baselineColor:"#484848",
gridlines:{color:"#484848"},textStyle:{color:"#484848"}},hAxis:{textStyle:{color:"#484848"}}},
r=new google.visualization.LineChart(document.getElementById(l));break;


case"area":t={chartArea:{left:50,top:20,width:"100%",height:"70%"},
legend:{position:"bottom"},fontName:"Poppins",
backgroundColor:c,vAxis:{baselineColor:"#484848",gridlines:{color:"#484848"},
textStyle:{color:"#484848"}},hAxis:{textStyle:{color:"#484848"}}},
r=new google.visualization.AreaChart(document.getElementById(l))}else switch(s){case"circle":t={chartArea:{left:0,top:0,width:"100%",
height:"75%"},legend:{position:"bottom"},colors:["#304ffe","#f60e0e","#ffa000"],fontName:"Poppins",
backgroundColor:c},r=new google.visualization.PieChart(document.getElementById(l));break;

case"donut":t={pieHole:1,chartArea:{left:0,top:10,width:"100%",height:"100%"},legend:{position:"right"},
colors:["#304ffe","#f60e0e","#ffa000", "00f700", "a5236e"],fontName:"Poppins",backgroundColor:c},
r=new google.visualization.PieChart(document.getElementById(l));break;




case"column":t={chartArea:{left:30,top:10,width:"100%",height:"90%"},colors:["#304ffe","#f60e0e","#ffa000"],fontName:"Poppins",backgroundColor:c},r=new google.visualization.ColumnChart(document.getElementById(l));break;
case"curve":t={chartArea:{left:30,top:10,width:"90%",height:"80%"},curveType:"function",colors:["#304ffe","#f60e0e","#ffa000"],fontName:"Poppins",backgroundColor:c},r=new google.visualization.LineChart(document.getElementById(l));break;
case"line":t={chartArea:{left:30,top:10,width:"90%",height:"80%"},
fontName:"Poppins",backgroundColor:c},r=new google.visualization.LineChart(document.getElementById(l));break;

case"area":t={chartArea:{left:50,top:20,width:"100%",height:"70%"},
legend:{position:"bottom"},fontName:"Poppins",backgroundColor:c},
r=new google.visualization.AreaChart(document.getElementById(l))}r.draw(o,t)}})},resizeNotice:function(){e(".notice-popup").each(function(){var t=e(this),o=parseInt(t.data("space"),10)>0?parseInt(t.data("space"),10):75,r=e(window).height()-o;t.attr("style",""),t.height()>r&&t.css({height:r})})}},t.plugin={init:function(){return t.plugin.chart(),t.plugin.mCustomScrollbar(),t.plugin.select2(),t.plugin.ui.accordion(),t.plugin.ui.slider(),t.plugin.ui.sortable(),t.plugin.ui.tabs(),t.plugin.waves(),t.plugin.isotope.filter(),!1},chart:function(){return e(".js__chart").length&&(google.charts.load("current",{packages:["corechart"]}),google.charts.setOnLoadCallback(t.func.getChart)),!1},isotope:{init:function(){return setTimeout(function(){e(".js__filter_isotope").each(function(){var t=e(this);t.find(".js__isotope_items").isotope({itemSelector:".js__isotope_item",layoutMode:"cellsByRow"})})},100),!1},filter:function(){return e(".js__filter_isotope").each(function(){var t=e(this);t.on("click",".js__filter_control",function(o){return o.preventDefault(),e(this).hasClass(".js__active")||(t.find(".js__filter_control").removeClass("js__active"),e(this).addClass("js__active"),t.find(".js__isotope_items").isotope({filter:e(this).data("filter")})),!1})}),!1}},mCustomScrollbar:function(){return e(".main-menu").length&&e(".main-menu .content").mCustomScrollbar(),e(".notice-popup").length&&e(".notice-popup .content").mCustomScrollbar(),!1},select2:function(){return e(".js__select2").each(function(){var t=e(this).data("min-results"),o=e(this).data("container-class");t?("Infinity"==t?e(this).select2({minimumResultsForSearch:1/0}):e(this).select2({minimumResultsForSearch:parseInt(t,10)}),o&&e(this).on("select2:open",function(){return e(".select2-container--open").addClass(o),!1})):e(this).select2()}),!1},ui:{accordion:function(){return e(".js__ui_accordion").length&&e(".js__ui_accordion").accordion({heightStyle:"content",collapsible:!0}),!1},slider:function(){return e(".js__ui_slider").each(function(){var t=e(this),o=t.find(".js__slider_range"),r=t.find(".js__slider_amount"),a=parseInt(t.data("min"),10),n=parseInt(t.data("max"),10),i=parseInt(t.data("value-1"),10),l=parseInt(t.data("value-2"),10),s=t.data("range");l>0?(o.slider({range:!0,min:a,max:n,values:[i,l],slide:function(e,t){r.val("$"+t.values[0]+" - $"+t.values[1])}}),r.val("$"+o.slider("values",0)+" - $"+o.slider("values",1))):(o.slider({range:s,min:a,max:n,value:i,slide:function(e,t){r.val("$"+t.value)}}),r.val("$"+o.slider("value")))}),!1},sortable:function(){return e(".js__sortable").length&&e(".js__sortable").sortable({revert:!0,start:function(e,t){t.placeholder.height(t.item.height()-20),t.placeholder.css("visibility","visible")}}),!1},tabs:function(){return e(".js__ui_tab").length&&e(".js__ui_tab").tabs(),!1}},waves:function(){return e(".js__control").length&&(Waves.attach(".js__control"),Waves.init()),!1}}}(jQuery);